...
export declare class Sanitizer {
     ...
     */
    static blacklist(str: string, chars: string): string;
    /**
     ...
     */
    static normalizeEmail(str: string, lowercase?: boolean): string | false;
    /**
     ...
     */
    static stripLow(str: string, keepNewLines?: boolean): string;
    /**
     * Convert the input to a boolean.
     * Everything except for '0', 'false' and '' returns true. In strict mode only '1' and 'true' return true.
     */
    static toBoolean(input: any, isStrict?: boolean): boolean;
    /**
     ...
     */
    static toFloat(input: any): number;
    /**
     * Convert the input to an integer, or NaN if the input is not an integer.
     */
    static toInt(input: any, radix?: number): number;
    /**
     ...
     */
    static whitelist(str: string, chars: string): string;
    /**
     * Performs sanitation of the given object based on the decorator annotations in the class definition.
     */
    sanitize<T = Record<string, any>>(classInstance: InstanceType<any>): T;
    /**
     ...
     */
    sanitizeAsync<T>(classInstance: T): Promise<T>;
    /**
