...
exports.BroadcastMemberService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const base_room_service_1 = require("../../core/common/base.room.service");
let BroadcastMemberService = class BroadcastMemberService extends base_room_service_1.BaseRoomService {
    constructor(model) {
        super();
        this.model = model;
    }
    ...
    async findByIdOrThrow(id, select) {
        ...
        if (!m)
            throw new common_1.NotFoundException("broadcast with id " + id + " not found in db");
        return m;
    }
    ...
    async getBroadcastMembersCount(bId) {
...
BroadcastMemberService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('broadcast_member')),
    __metadata("design:paramtypes", [Object])
], BroadcastMemberService);
exports.BroadcastMemberService = BroadcastMemberService;
//# sourceMappingURL=broadcast_member.service.js.map