...
exports.OrderRoomSettingsService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const base_room_service_1 = require("../../core/common/base.room.service");
let OrderRoomSettingsService = class OrderRoomSettingsService extends base_room_service_1.BaseRoomService {
    constructor(model) {
        super();
        this.model = model;
    }
...
OrderRoomSettingsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('order_room_settings')),
    __metadata("design:paramtypes", [mongoose_2.Model])
], OrderRoomSettingsService);
exports.OrderRoomSettingsService = OrderRoomSettingsService;
