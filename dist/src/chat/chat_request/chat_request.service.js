...
let ChatRequestService = class ChatRequestService extends base_service_1.BaseService {
    constructor(model) {
        super();
        this.model = model;
    }
    ...
    async findByIdOrThrow(id, select) {
        ...
        if (!m)
            throw new common_1.NotFoundException("chatRequest with id " + id + " not found in db");
        return m;
    }
...
ChatRequestService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)("chat_request")),
    __metadata("design:paramtypes", [Object])
], ChatRequestService);
exports.ChatRequestService = ChatRequestService;
//# sourceMappingURL=chat_request.service.js.map