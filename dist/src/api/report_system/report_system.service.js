...
exports.ReportSystemService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const base_service_1 = require("../../core/common/base.service");
let ReportSystemService = class ReportSystemService extends base_service_1.BaseService {
    constructor(model) {
        super();
        this.model = model;
    }
    ...
    async findByIdOrThrow(id, select) {
        ...
        if (!m)
            throw new common_1.NotFoundException("report member with id " + id + " not found in db");
        return m;
    }
...
ReportSystemService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('reports')),
    __metadata("design:paramtypes", [Object])
], ReportSystemService);
exports.ReportSystemService = ReportSystemService;
//# sourceMappingURL=report_system.service.js.map